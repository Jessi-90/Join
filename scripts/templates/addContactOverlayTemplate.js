    ...
    <div class="form-container">
        ...
        <form>
            ...
            <div class="add-contact-buttons">
                <button class="add-contact-cancel btn-light" id="cancel-contact" onclick="closeAddContactOverlay(event)">Cancel <img class="cancel-x"
                        src="../assets/icons/cancel.svg"></button>
                <button class="add-contact-create btn-dark" id="create-contact" onclick="createContact(event)">Create contact <img class="create-check"
